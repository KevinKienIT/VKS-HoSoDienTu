...
KSV can lam duoc it nhat 8 viec sau:

1. Xem nhanh mot case dang co nhung file nao.
2. Biet tung file la van ban gi ma khong can mo thu cong tung PDF.
...
5. Mo tai lieu va thay ro file goc, trang, but luc, do tin cay OCR, trich dan.
...
| `module_ocr` | Lay text va confidence | page image | ocr_text, line boxes, confidence | pipeline |
...
| `module_ai_offline_assistant` | Tom tat, hoi dap, phan tich co trich dan | indexed docs, query | answer, summary, citation list | KSV |
