...
| FND-005 | Verify OCR from stored PNG | 🔲 READY_AFTER_FND_004 | Agent | Pipeline | OCR reads from `pages.image_path`, not PDF | E2E OCR test | `pages.ocr_status='done'`, `ocr_text` not empty |
